...
\begin{figure}[t]
    ...
    \caption{Geographical distributions of five species within Giraffa. Bright region on map shows historical (ca. 1700) giraffe ranges. %
    ...
    \blue{[Updated figure to use custom image, modified from 'https://giraffeconservation.org/giraffe-species/'. Updated colours to match between geographic distributions, and the phylogenetic trees.]}
} \label{fig:giraffe}
\end{figure}
